  ...
  return (
    <ContractGuideContainer>
      ...
      <ContractGuideItem>
        ...
        <p><b>Sent for ISP Confirmation</b></p>
      ...
      <ContractGuideItem>
        ...
        <p><b>Confirmed</b></p>
        <div className='super-small'>Every party has agreed on the contract terms and the starting date of the contract has not arrived.</div>
      </ContractGuideItem>

      <ContractGuideItem>
        <span><ContractStatusWidget selected={false} average={18} good={25} expired={false} payments={67} /></span>
        <p><b>Ongoing</b></p>
        <div className='super-small'>The contract is in progress so schools start getting connected, metrics reported, and payments performed.</div>
      </ContractGuideItem>

      <ContractGuideItem>
        <span><ContractStatusWidget selected={false} average={10} good={80} expired={false} payments={100} /></span>
        <p><b>Expired</b></p>
